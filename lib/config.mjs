...
export const CONFIG = {
  ...
  claudeModels: {
    ...
    // Wall Label bench (/label): three full scripts per image, so it gets the
    // Writer's model and a bigger token ceiling (see handleClaude).
    label:  E.CLAUDE_MODEL_LABEL  || E.CLAUDE_MODEL_WRITE || "claude-sonnet-5"
  },
